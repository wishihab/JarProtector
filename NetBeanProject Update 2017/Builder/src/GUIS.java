...
public class GUIS extends JFrame {
	...
	public static GUIS instance; //current UI instance, so other classes can use this instance as parent for messageboxes (such as an displaying error)
	...
	private void initialize() {
		instance = this;
		setIconImage(new ImageIcon(GUIS.class.getResource("protect.png"))
				.getImage());
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (i == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						List<String> classes = Utils.dapetKelas(jumpa); //get list of all classes from jar
						String main = Utils.getKelasUtama(jumpa); //main class from jar
		...
		btnOpenjarTo.setIcon(new ImageIcon(GUIS.class.getResource("open.png")));
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (i == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						if (from.length() == 0) {
							JOptionPane
									.showMessageDialog(GUIS.instance,
						...
						if (to.equals(from) && run) {
							JOptionPane.showMessageDialog(GUIS.instance,
						...
						if (!to.endsWith(".jar") && run) {
							ext = JOptionPane
									.showConfirmDialog(GUIS.instance,
						...
						if (run && ext)
							Builddsss.bangunKeluar(from, to,
		...
		btnProtect.setIcon(new ImageIcon(GUIS.class.getResource("protect.png")));
		...
		btnRandomEncryptionKey.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				keyField.setText(Utils.generateEncryptionKey(Builddsss.KEY_SIZE));
			}
		});
		btnRandomEncryptionKey.setIcon(new ImageIcon(GUIS.class
				.getResource("key.png")));
